...
public class PatientDaoImpl extends AbstractDao<PatientEntity,Long> implements PatientDao {
    ...
    @Override
    public List<PatientEntity> findPatientsPremium(Boolean premium) {
        List<PatientEntity> patients = entityManager.createQuery("SELECT p FROM PatientEntity p WHERE p.premium = :premium", PatientEntity.class)
